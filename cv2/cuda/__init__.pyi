...
@_typing.overload
def absSum(src: cv2.typing.MatLike, mask: cv2.typing.MatLike | None = ...) -> tuple[float, float, float, float]: ...
@_typing.overload
def absSum(src: GpuMat, mask: GpuMat | None = ...) -> tuple[float, float, float, float]: ...
@_typing.overload
def absSum(src: cv2.UMat, mask: cv2.UMat | None = ...) -> tuple[float, float, float, float]: ...
...
@_typing.overload
def absdiffWithScalar(src1: cv2.typing.MatLike, src2: cv2.typing.Scalar, dst: cv2.typing.MatLike | None = ..., stream: Stream = ...) -> cv2.typing.MatLike: ...
@_typing.overload
def absdiffWithScalar(src1: GpuMat, src2: cv2.typing.Scalar, dst: GpuMat | None = ..., stream: Stream = ...) -> GpuMat: ...
@_typing.overload
def absdiffWithScalar(src1: cv2.UMat, src2: cv2.typing.Scalar, dst: cv2.UMat | None = ..., stream: Stream = ...) -> cv2.UMat: ...
...
@_typing.overload
def addWithScalar(src1: cv2.typing.MatLike, src2: cv2.typing.Scalar, dst: cv2.typing.MatLike | None = ..., mask: cv2.typing.MatLike | None = ..., dtype: int = ..., stream: Stream = ...) -> cv2.typing.MatLike: ...
@_typing.overload
def addWithScalar(src1: GpuMat, src2: cv2.typing.Scalar, dst: GpuMat | None = ..., mask: GpuMat | None = ..., dtype: int = ..., stream: Stream = ...) -> GpuMat: ...
@_typing.overload
def addWithScalar(src1: cv2.UMat, src2: cv2.typing.Scalar, dst: cv2.UMat | None = ..., mask: cv2.UMat | None = ..., dtype: int = ..., stream: Stream = ...) -> cv2.UMat: ...
...
@_typing.overload
def bitwise_and_with_scalar(src1: cv2.typing.MatLike, src2: cv2.typing.Scalar, dst: cv2.typing.MatLike | None = ..., mask: cv2.typing.MatLike | None = ..., stream: Stream = ...) -> cv2.typing.MatLike: ...
@_typing.overload
def bitwise_and_with_scalar(src1: GpuMat, src2: cv2.typing.Scalar, dst: GpuMat | None = ..., mask: GpuMat | None = ..., stream: Stream = ...) -> GpuMat: ...
@_typing.overload
def bitwise_and_with_scalar(src1: cv2.UMat, src2: cv2.typing.Scalar, dst: cv2.UMat | None = ..., mask: cv2.UMat | None = ..., stream: Stream = ...) -> cv2.UMat: ...
...
@_typing.overload
def bitwise_or_with_scalar(src1: cv2.typing.MatLike, src2: cv2.typing.Scalar, dst: cv2.typing.MatLike | None = ..., mask: cv2.typing.MatLike | None = ..., stream: Stream = ...) -> cv2.typing.MatLike: ...
@_typing.overload
def bitwise_or_with_scalar(src1: GpuMat, src2: cv2.typing.Scalar, dst: GpuMat | None = ..., mask: GpuMat | None = ..., stream: Stream = ...) -> GpuMat: ...
@_typing.overload
def bitwise_or_with_scalar(src1: cv2.UMat, src2: cv2.typing.Scalar, dst: cv2.UMat | None = ..., mask: cv2.UMat | None = ..., stream: Stream = ...) -> cv2.UMat: ...
...
@_typing.overload
def bitwise_xor_with_scalar(src1: cv2.typing.MatLike, src2: cv2.typing.Scalar, dst: cv2.typing.MatLike | None = ..., mask: cv2.typing.MatLike | None = ..., stream: Stream = ...) -> cv2.typing.MatLike: ...
@_typing.overload
def bitwise_xor_with_scalar(src1: GpuMat, src2: cv2.typing.Scalar, dst: GpuMat | None = ..., mask: GpuMat | None = ..., stream: Stream = ...) -> GpuMat: ...
@_typing.overload
def bitwise_xor_with_scalar(src1: cv2.UMat, src2: cv2.typing.Scalar, dst: cv2.UMat | None = ..., mask: cv2.UMat | None = ..., stream: Stream = ...) -> cv2.UMat: ...
...
@_typing.overload
def cartToPolar(xy: cv2.typing.MatLike, magnitude: cv2.typing.MatLike | None = ..., angle: cv2.typing.MatLike | None = ..., angleInDegrees: bool = ..., stream: Stream = ...) -> tuple[cv2.typing.MatLike, cv2.typing.MatLike]: ...
@_typing.overload
def cartToPolar(xy: GpuMat, magnitude: GpuMat | None = ..., angle: GpuMat | None = ..., angleInDegrees: bool = ..., stream: Stream = ...) -> tuple[GpuMat, GpuMat]: ...
@_typing.overload
def cartToPolar(xy: cv2.UMat, magnitude: cv2.UMat | None = ..., angle: cv2.UMat | None = ..., angleInDegrees: bool = ..., stream: Stream = ...) -> tuple[cv2.UMat, cv2.UMat]: ...
@_typing.overload
def cartToPolar(xy: cv2.typing.MatLike, magnitudeAngle: cv2.typing.MatLike | None = ..., angleInDegrees: bool = ..., stream: Stream = ...) -> cv2.typing.MatLike: ...
@_typing.overload
def cartToPolar(xy: GpuMat, magnitudeAngle: GpuMat | None = ..., angleInDegrees: bool = ..., stream: Stream = ...) -> GpuMat: ...
@_typing.overload
def cartToPolar(xy: cv2.UMat, magnitudeAngle: cv2.UMat | None = ..., angleInDegrees: bool = ..., stream: Stream = ...) -> cv2.UMat: ...
...
@_typing.overload
def compareWithScalar(src1: cv2.typing.MatLike, src2: cv2.typing.Scalar, cmpop: int, dst: cv2.typing.MatLike | None = ..., stream: Stream = ...) -> cv2.typing.MatLike: ...
@_typing.overload
def compareWithScalar(src1: GpuMat, src2: cv2.typing.Scalar, cmpop: int, dst: GpuMat | None = ..., stream: Stream = ...) -> GpuMat: ...
@_typing.overload
def compareWithScalar(src1: cv2.UMat, src2: cv2.typing.Scalar, cmpop: int, dst: cv2.UMat | None = ..., stream: Stream = ...) -> cv2.UMat: ...
...
@_typing.overload
def divideWithScalar(src1: cv2.typing.MatLike, src2: cv2.typing.Scalar, dst: cv2.typing.MatLike | None = ..., scale: float = ..., dtype: int = ..., stream: Stream = ...) -> cv2.typing.MatLike: ...
@_typing.overload
def divideWithScalar(src1: GpuMat, src2: cv2.typing.Scalar, dst: GpuMat | None = ..., scale: float = ..., dtype: int = ..., stream: Stream = ...) -> GpuMat: ...
@_typing.overload
def divideWithScalar(src1: cv2.UMat, src2: cv2.typing.Scalar, dst: cv2.UMat | None = ..., scale: float = ..., dtype: int = ..., stream: Stream = ...) -> cv2.UMat: ...
...
@_typing.overload
def maxWithScalar(src1: cv2.typing.MatLike, src2: cv2.typing.Scalar, dst: cv2.typing.MatLike | None = ..., stream: Stream = ...) -> cv2.typing.MatLike: ...
@_typing.overload
def maxWithScalar(src1: GpuMat, src2: cv2.typing.Scalar, dst: GpuMat | None = ..., stream: Stream = ...) -> GpuMat: ...
@_typing.overload
def maxWithScalar(src1: cv2.UMat, src2: cv2.typing.Scalar, dst: cv2.UMat | None = ..., stream: Stream = ...) -> cv2.UMat: ...
...
@_typing.overload
def minWithScalar(src1: cv2.typing.MatLike, src2: cv2.typing.Scalar, dst: cv2.typing.MatLike | None = ..., stream: Stream = ...) -> cv2.typing.MatLike: ...
@_typing.overload
def minWithScalar(src1: GpuMat, src2: cv2.typing.Scalar, dst: GpuMat | None = ..., stream: Stream = ...) -> GpuMat: ...
@_typing.overload
def minWithScalar(src1: cv2.UMat, src2: cv2.typing.Scalar, dst: cv2.UMat | None = ..., stream: Stream = ...) -> cv2.UMat: ...
...
@_typing.overload
def multiplyWithScalar(src1: cv2.typing.MatLike, src2: cv2.typing.Scalar, dst: cv2.typing.MatLike | None = ..., scale: float = ..., dtype: int = ..., stream: Stream = ...) -> cv2.typing.MatLike: ...
@_typing.overload
def multiplyWithScalar(src1: GpuMat, src2: cv2.typing.Scalar, dst: GpuMat | None = ..., scale: float = ..., dtype: int = ..., stream: Stream = ...) -> GpuMat: ...
@_typing.overload
def multiplyWithScalar(src1: cv2.UMat, src2: cv2.typing.Scalar, dst: cv2.UMat | None = ..., scale: float = ..., dtype: int = ..., stream: Stream = ...) -> cv2.UMat: ...
...
@_typing.overload
def phase(xy: cv2.typing.MatLike, angle: cv2.typing.MatLike | None = ..., angleInDegrees: bool = ..., stream: Stream = ...) -> cv2.typing.MatLike: ...
@_typing.overload
def phase(xy: GpuMat, angle: GpuMat | None = ..., angleInDegrees: bool = ..., stream: Stream = ...) -> GpuMat: ...
@_typing.overload
def phase(xy: cv2.UMat, angle: cv2.UMat | None = ..., angleInDegrees: bool = ..., stream: Stream = ...) -> cv2.UMat: ...
...
@_typing.overload
def polarToCart(magnitude: cv2.typing.MatLike, angle: cv2.typing.MatLike, xy: cv2.typing.MatLike | None = ..., angleInDegrees: bool = ..., stream: Stream = ...) -> cv2.typing.MatLike: ...
@_typing.overload
def polarToCart(magnitude: GpuMat, angle: GpuMat, xy: GpuMat | None = ..., angleInDegrees: bool = ..., stream: Stream = ...) -> GpuMat: ...
@_typing.overload
def polarToCart(magnitude: cv2.UMat, angle: cv2.UMat, xy: cv2.UMat | None = ..., angleInDegrees: bool = ..., stream: Stream = ...) -> cv2.UMat: ...
@_typing.overload
def polarToCart(magnitudeAngle: cv2.typing.MatLike, xy: cv2.typing.MatLike | None = ..., angleInDegrees: bool = ..., stream: Stream = ...) -> cv2.typing.MatLike: ...
@_typing.overload
def polarToCart(magnitudeAngle: GpuMat, xy: GpuMat | None = ..., angleInDegrees: bool = ..., stream: Stream = ...) -> GpuMat: ...
@_typing.overload
def polarToCart(magnitudeAngle: cv2.UMat, xy: cv2.UMat | None = ..., angleInDegrees: bool = ..., stream: Stream = ...) -> cv2.UMat: ...
...
@_typing.overload
def sqrSum(src: cv2.typing.MatLike, mask: cv2.typing.MatLike | None = ...) -> tuple[float, float, float, float]: ...
@_typing.overload
def sqrSum(src: GpuMat, mask: GpuMat | None = ...) -> tuple[float, float, float, float]: ...
@_typing.overload
def sqrSum(src: cv2.UMat, mask: cv2.UMat | None = ...) -> tuple[float, float, float, float]: ...
...
@_typing.overload
def subtractWithScalar(src1: cv2.typing.MatLike, src2: cv2.typing.Scalar, dst: cv2.typing.MatLike | None = ..., mask: cv2.typing.MatLike | None = ..., dtype: int = ..., stream: Stream = ...) -> cv2.typing.MatLike: ...
@_typing.overload
def subtractWithScalar(src1: GpuMat, src2: cv2.typing.Scalar, dst: GpuMat | None = ..., mask: GpuMat | None = ..., dtype: int = ..., stream: Stream = ...) -> GpuMat: ...
@_typing.overload
def subtractWithScalar(src1: cv2.UMat, src2: cv2.typing.Scalar, dst: cv2.UMat | None = ..., mask: cv2.UMat | None = ..., dtype: int = ..., stream: Stream = ...) -> cv2.UMat: ...

@_typing.overload
def sum(src: cv2.typing.MatLike, mask: cv2.typing.MatLike | None = ...) -> tuple[float, float, float, float]: ...
@_typing.overload
def sum(src: GpuMat, mask: GpuMat | None = ...) -> tuple[float, float, float, float]: ...
@_typing.overload
def sum(src: cv2.UMat, mask: cv2.UMat | None = ...) -> tuple[float, float, float, float]: ...
